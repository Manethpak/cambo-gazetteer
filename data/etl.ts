...
const provinceMapping: Record<string, { code: string; name_en: string; name_km: string; type: 'province' | 'municipality' }> = {
  '01. Banteay Meanchey': { code: '01', name_en: 'Banteay Meanchey', name_km: 'បន្ទាយមានជ័យ', type: 'province' },
  '02. Battambang': { code: '02', name_en: 'Battambang', name_km: 'បាត់ដំបង', type: 'province' },
  '03. Kampong Cham': { code: '03', name_en: 'Kampong Cham', name_km: 'កំពង់ចាម', type: 'province' },
  '04. Kampong Chhnang': { code: '04', name_en: 'Kampong Chhnang', name_km: 'កំពង់ឆ្នាំង', type: 'province' },
  '05. Kampong Speu': { code: '05', name_en: 'Kampong Speu', name_km: 'កំពង់ស្ពឺ', type: 'province' },
  '06. Kampong Thom': { code: '06', name_en: 'Kampong Thom', name_km: 'កំពង់ធំ', type: 'province' },
  '07. Kampot': { code: '07', name_en: 'Kampot', name_km: 'កំពត', type: 'province' },
  '08. Kandal': { code: '08', name_en: 'Kandal', name_km: 'កណ្ដាល', type: 'province' },
  '09. Koh Kong': { code: '09', name_en: 'Koh Kong', name_km: 'កោះកុង', type: 'province' },
  '10. Kratie': { code: '10', name_en: 'Kratie', name_km: 'ក្រចេះ', type: 'province' },
  '11. Mondul Kiri': { code: '11', name_en: 'Mondulkiri', name_km: 'មណ្ឌលគីរី', type: 'province' },
  '12. Phnom Penh': { code: '12', name_en: 'Phnom Penh', name_km: 'ភ្នំពេញ', type: 'municipality' },
  '13. Preah Vihear': { code: '13', name_en: 'Preah Vihear', name_km: 'ព្រះវិហារ', type: 'province' },
  '14. Prey Veng': { code: '14', name_en: 'Prey Veng', name_km: 'ព្រៃវែង', type: 'province' },
  '15. Pursat': { code: '15', name_en: 'Pursat', name_km: 'ពោធិ៍សាត់', type: 'province' },
  '16. Ratanak Kiri': { code: '16', name_en: 'Ratanakiri', name_km: 'រតនគិរី', type: 'province' },
  '17. Siemreap': { code: '17', name_en: 'Siem Reap', name_km: 'សៀមរាប', type: 'province' },
  '18. Preah Sihanouk': { code: '18', name_en: 'Preah Sihanouk', name_km: 'ព្រះសីហនុ', type: 'province' },
  '19. Stung Treng': { code: '19', name_en: 'Stung Treng', name_km: 'ស្ទឹងត្រែង', type: 'province' },
  '20. Svay Rieng': { code: '20', name_en: 'Svay Rieng', name_km: 'ស្វាយរៀង', type: 'province' },
  '21. Takeo': { code: '21', name_en: 'Takeo', name_km: 'តាកែវ', type: 'province' },
  '22. Oddar Meanchey': { code: '22', name_en: 'Oddar Meanchey', name_km: 'ឧត្តរមានជ័យ', type: 'province' },
  '23. Kep': { code: '23', name_en: 'Kep', name_km: 'កែប', type: 'municipality' },
  '24. Pailin': { code: '24', name_en: 'Pailin', name_km: 'ប៉ៃលិន', type: 'municipality' },
  '25. Tboung Khmum': { code: '25', name_en: 'Tboung Khmum', name_km: 'ត្បូងឃ្មុំ', type: 'province' },
};
 ...
 */
function transformToHierarchical(units: AdministrativeUnit[]): HierarchicalProvince[] {
  ...
  console.log(`✅ Created hierarchical structure with ${provinces.length} provinces`);
  return provinces;
}
...
function main() {
  ...
  const inputFile = join(__dirname, '2024.10.14.xlsx');
  ...
  writeFileSync(hierarchicalOutput, JSON.stringify(hierarchical, null, 2), 'utf-8');
