...
export const districtsQuerySchema = paginationQuerySchema.extend({
  province: z
    ...
    .optional()
    .describe(
      "Filter districts by province code (e.g., '1' for Banteay Meanchey)",
    ),
});
...
export const communesQuerySchema = paginationQuerySchema.extend({
  district: z
    ...
    .optional()
    .describe(
      "Filter communes by district code (e.g., '101' for Serei Saophoan)",
    ),
});
...
export const villagesQuerySchema = paginationQuerySchema.extend({
  commune: z
    ...
    .optional()
    .describe(
      "Filter villages by commune code (e.g., '10101' for Serei Saophoan)",
    ),
});
