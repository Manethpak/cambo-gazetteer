        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-300 mb-8 leading-relaxed max-w-3xl">
              Location data in Cambodia is fragmented across systems,
              mistranslated across languages, and stored in inconsistent ways.
              This creates real problems for developers, businesses, and
              government agencies trying to build reliable systems.
            </p>

            <p className="text-lg text-slate-400">
              Discover how Cambodia Gazetteer solves this with a unified,
              standardized approach to geographical data.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Every time you fill out a form with your address in Cambodia,
                you encounter inconsistencies. When developers store this data,
                they struggle with the lack of standardization.
              </p>
            </div>
              ...
              <div className="p-6">
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-amber-200">
                      <code className="text-sm text-slate-700 block">
                        "លេខផ្ទះ, ផ្លូវ, ឃុំ/សង្កាត់, ស្រុក/ក្រុង,
                        ខេត្ត/រាជធានី"
                      </code>
                ...
                <div className="mt-4 pt-4 border-t border-amber-200">
                  <p className="text-amber-800 leading-relaxed mb-3">
                    <strong className="text-amber-900">The Problem:</strong>{" "}
                    Government databases store citizen addresses as free-text
                    strings in Khmer. Each field is manually entered, leading
                    to:
                  </p>
                  <ul className="space-y-2 text-sm text-amber-800">
                    <li className="flex gap-2">
                      ...
                      <span>
                        Inconsistent spelling and formatting across different
                        records
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-amber-600">•</span>
                      <span>
                        No validation against official administrative divisions
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-amber-600">•</span>
                      <span>
                        Difficult to query, aggregate, or analyze location-based
                        data
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-amber-600">•</span>
                      <span>
                        Translation errors when converting between Khmer and
                        English systems
                      </span>
                    </li>
                  </ul>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Instead of storing fragmented data across columns, use a single
                administrative code. One code contains everything—location name
                in Khmer & English, hierarchy, and metadata.
              </p>
            </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                See how the code becomes simpler, cleaner, and more reliable
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-indigo-100 mb-10 leading-relaxed">
              Start using Cambodia Gazetteer in your next project. Standardize
              your location data, simplify your code, and ship faster.
            </p>
